...
- @@html:<icon class="fa-solid fa-pen-nib"></icon>@@ [[./assets/CV.pdf][CV]] (last updated October 2025)
#+END_coordinates

** Research
#+BEGIN_research-list
1. /[[https://arxiv.org/abs/2510.08526][Convergence Theorems for Entropy-Regularized and Distributional
   Reinforcement Learning]]/. @@html:<br/>@@
   Yash Jhaveri*, *Harley Wiltzer**, Patrick Shafto, Marc G. Bellemare,
   David Meger. @@html:<br/>@@
   To appear in Neural Information Processing Systems (NeurIPS), 2025.
   #+BEGIN_paperlinks
   [[https://arxiv.org/pdf/2510.08526][pdf]]
   #+END_paperlinks
2. /[[https://arnavkj1995.github.io/SFM][Non-Adversarial Inverse Reinforcement Learning via Successor Feature
   Matching]]/. @@html:<br/>@@
   ...
   #+END_paperlinks
3. /[[https://arxiv.org/abs/2410.11022][Action Gaps and Advantages in Continuous-Time Distributional Reinforcement
   Learning]]/. @@html:<br/>@@
   *Harley Wiltzer**, Marc G. Bellemare, David Meger, Patrick Shafto, Yash
   ...
   #+END_paperlinks
4. /[[https://arxiv.org/abs/2409.00328][Foundations of Multivariate Distributional Reinforcement Learning]]/. @@html:
   <br/>@@
   *Harley Wiltzer*, Jesse Farebrother, Arthur Gretton, Mark Rowland @@html:
   ...
   #+END_paperlinks
5. /[[https://openreview.net/pdf?id=hAH6ZBLOAB][Simplifying Constraint Inference with Inverse Reinforcement Learning]]/.
   @@html:<br/>@@
   ...
   #+END_paperlinks
6. /[[https://deepmind.google/research/publications/44717/][A
   ...
   *Harley Wiltzer**, Jesse Farebrother*, Arthur Gretton, Yunhao Tang,
   ...
   #+END_paperlinks
7. /[[https://arxiv.org/abs/2309.14597][Policy Optimization in a Noisy
   ...
   #+END_paperlinks
8. /[[https://arxiv.org/abs/2205.12184][Distributional Hamilton-Jacobi-Bellman Equations for
...
9. [[./assets/thesis-msc.pdf][On the Evolution of Return Distributions in Continuous-Time
   Reinforcement Learning]]. @@html: <br/>@@
   M.Sc. Thesis.
#+END_research-list
